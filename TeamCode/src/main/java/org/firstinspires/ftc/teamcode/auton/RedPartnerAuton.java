...
public class RedPartnerAuton extends OpMode {
    ...
    private void buildPaths() {
        path1 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(90.212, 6.771),
                                new Pose(86.13922093143132, 16.24675388096388)
                        )
                )
